...
public class App {
	...
	public static void main(String[] args) {
		long lStartTime = System.nanoTime();
		  ...
		  @SuppressWarnings("rawtypes") Class cls = null;
		  ...
		  cls = Class.forName(fullPathOfTheClass); PEuler myTestObject =
		  (PEuler) cls.newInstance();
		  System.out.println(myTestObject.Solution()); } catch (Exception e) {
